    ...
    team_members = [
        {
            ...
            'image_file':'static/images/about-us/Chen.JPG', 
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Robinson.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Johnson.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Kim.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Clarke.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Fisher.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Gonzales.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Dubois.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Bennett.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Park.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/about-us/Petrova.JPG',
         ...
         },
        {
            ...
            'image_file':'static/images/about-us/Lee.JPG',
    ...
    programs = [
        {
            ...
            'image_file':'static/images/programs/piano.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/strings.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/winds.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/guitar.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/voice.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/theory.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/orchestra.JPG',
        ...
        },
        {
            ...
            'image_file':'static/images/programs/intro.JPG',
...
def gallery():
    albums = [
        {"name": "Musical Theater", 
         "cover_image": "static/images/gallery/theater/theater1.jpg", 
         "cover_alt": "Cover image of the Musical Theater album showing a dramatic stage scene with two young children.",
         "images": [
             {"url": "static/images/gallery/theater/theater1.jpg", "alt": "Two children perform on stage during a musical theater festival at SCCM, surrounded by stage decorations and red curtains."},
             {"url": "static/images/gallery/theater/theater2.jpg", "alt": "A group of theater students and a director engaged in a discussion during a rehearsal on stage, illuminated by bright stage lights."},
             {"url": "static/images/gallery/theater/theater3.jpg", "alt": "Three actors in period costumes, including a woman in a white gown and two men in formal suits and top hats, perform a scene with candlelight in the background."},
             {"url": "static/images/gallery/theater/theater4.jpg", "alt": "A large ensemble of performers in historical costumes sing and gesture dramatically during a musical theater performance."},
             {"url": "static/images/gallery/theater/theater5.jpg", "alt": "Three actors in medieval-style costumes, sitting and standing around a table with lit candles, performing a dramatic scene."},
             {"url": "static/images/gallery/theater/theater6.jpg", "alt": "A group of performers in extravagant wigs and costumes engage in a lively dance on a brightly lit stage, with a colorful backdrop depicting a carnival scene."}
         ]
        },
        {"name": "Chamber Choirs", 
         "cover_image": "static/images/gallery/chamber/chamber1.jpg", 
         "cover_alt": "Cover image of the Chamber Choirs album showing choir members mid-song during a performance.",
         "images": [
             {"url": "static/images/gallery/chamber/chamber1.jpg", "alt": "Male choir in matching gray vests and black bow ties sing passionately in a choir performance."},
             {"url": "static/images/gallery/chamber/chamber2.jpg", "alt": "A male choir with members dressed in gray vests and black bow ties performing on stage with focused expressions."},
             {"url": "static/images/gallery/chamber/chamber3.jpg", "alt": "Student choir holding yellow flowers while singing, led by a conductor in a white shirt, during a rehearsal."},
             {"url": "static/images/gallery/chamber/chamber4.jpg", "alt": "Boys choir, each holding a yellow flower, attentively following the conductor's lead in a church setting."},
             {"url": "static/images/gallery/chamber/chamber5.jpg", "alt": "Choir conductor leading a group of students holding lit candles during a solemn performance in a church."},
             {"url": "static/images/gallery/chamber/chamber6.jpg", "alt":  "Mixed adult chamber choir, dressed in black, singing from sheet music during a practice session."}
         ]
        },
        {"name": "SCCM Family Through The Years", 
         "cover_image": "static/images/gallery/sccm/sccm1.jpg", 
         ...
         "images": [
             {"url": "static/images/gallery/sccm/sccm1.jpg", "alt": "A music teacher wearing a pink mask instructs a diverse group of children, all wearing masks, around a table filled with music sheets and recorders, highlighting a moment in the SCCM's history of adapting music education during a pandemic."},
             {"url": "static/images/gallery/sccm/sccm2.jpg", "alt": "A young girl concentrating while playing a harp, with sheet music visible on the right."},
             {"url": "static/images/gallery/sccm/sccm3.jpg", "alt": "Three musicians performing a classical guitar piece on stage, with a grand piano in the background."},
             {"url": "static/images/gallery/sccm/sccm4.jpg", "alt": "A music teacher claps along with two young students, one singing and the other playing a small guitar, during a lesson at SCCM."},
             {"url": "static/images/gallery/sccm/sccm5.jpg", "alt": "A young student at SCCM holds a microphone and reads sheet music with a teacher, standing next to an open piano."},
             {"url": "static/images/gallery/sccm/sccm6.jpg", "alt": "A music teacher at SCCM sits at a piano with a group of young students, engaging them in a lesson."}
         ]
        }
    ]
